...
import floorplan from "./d3-floorplan/floorplan";
import heatmap from "./d3-floorplan/heatmap";
import overlays from "./d3-floorplan/overlays";
import pathplot from "./d3-floorplan/pathplot";
import vectorfield from "./d3-floorplan/vectorfield";
const d3={
    xml: xml,
        ...
        d3.xml(lady_image,function(xml_lady){
            var data = {
                ...
                yscale = d3.scale.linear()
                           .domain([0,33.79])
                           .range([0,380]),
                map = d3.floorplan.init().xScale(xscale).yScale(yscale),
